...
@section('title', 'Admin Course Sandbox')
...
<div class="bg-gray-50 min-h-screen py-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-4 bg-indigo-100 text-indigo-800 p-4 rounded-lg flex justify-between items-center shadow-sm border border-indigo-200">
            <div class="flex items-center gap-3">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                <span class="font-bold">Admin Sandbox</span> You are safely previewing this course exactly as a student would experience it.
            </div>
            <button onclick="window.close()" class="text-sm font-semibold hover:bg-gray-50 bg-white px-3 py-1.5 rounded-md shadow-sm border border-indigo-200 transition">Close Preview</button>
        </div>
